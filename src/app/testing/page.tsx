    ...
    return (
      <div className="rounded-xl bg-amber-500/10 border border-amber-500/30 p-6 text-amber-800">
        ...
        <p className="text-sm opacity-90 mb-2">
          From the <code className="bg-black/10 px-2 py-1 rounded">plant-sanctuary</code> directory, run:
        </p>
      ...
      <main className="container mx-auto px-4 py-10 sm:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-text-light mb-10">
            How we ensure quality and reliability across the Plant Sanctuary codebase.
          </p>
          ...
          <section className="mt-12 rounded-2xl bg-white/50 border border-gray-200 p-6 backdrop-blur-sm">
            ...
            <div className="space-y-2 font-mono text-sm">
              <p className="text-text">
                <span className="text-text-muted">$</span> npm run test
                <span className="text-text-muted ml-2">— Single run</span>
              </p>
              <p className="text-text">
                <span className="text-text-muted">$</span> npm run test:watch
                <span className="text-text-muted ml-2">— Watch mode</span>
              </p>
              <p className="text-text">
                <span className="text-text-muted">$</span> npm run test:coverage:public
                <span className="text-text-muted ml-2">— Generate coverage and copy to Testing page</span>
              </p>
              <p className="text-text">
                <span className="text-text-muted">$</span> npm run test:e2e
                <span className="text-text-muted ml-2">— Run Cypress E2E (headless)</span>
              </p>
              <p className="text-text">
                <span className="text-text-muted">$</span> npm run test:e2e:open
                <span className="text-text-muted ml-2">— Open Cypress UI for interactive E2E testing</span>
              </p>
            </div>
          </section>

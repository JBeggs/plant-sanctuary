...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-forest-background py-12" data-cy="cart-container">
      <div className="container-wide">
                  ...
                  <div className="w-24 h-24 flex-shrink-0 rounded-lg overflow-hidden bg-surface-raised">
                    {thumb ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <Leaf className="w-8 h-8 text-forest-primary/30" />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between">
                      ...
                      <button
                        ...
                        className="text-text-muted hover:text-forest-accent transition-colors"
                      >
